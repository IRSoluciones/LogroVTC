...
export const metadata: Metadata = {
  ...
  description:
    "VTC en La Rioja y Rioja Alavesa. Traslados a aeropuertos, Camino de Santiago y mensajería urgente. Teléfono 684200659.",
        ...
        <header className="sticky top-0 z-50 bg-background/80 backdrop-blur border-b border-border">
          <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm">
              ...
              <a href="/localidades" className="hover:underline">Localidades</a>
            </nav>
            <a
              href="tel:684200659"
            ...
            <div className="grid gap-6 md:grid-cols-4">
              ...
              <div className="space-y-3">
                ...
                <ul className="text-sm text-muted-foreground space-y-2">
                  ...
                  <li><a href="/localidades" className="hover:text-foreground">Localidades</a></li>
                </ul>
              </div>
            </div>
