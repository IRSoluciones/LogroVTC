...
export const localities: Locality[] = [
  {
    ...
    name: "Logroño",
    province: "La Rioja",
    intro: "Traslados VTC en Logroño y alrededores: aeropuertos, estaciones y rutas locales.",
    description:
      "Servicio VTC en Logroño con conductores profesionales. Traslados a aeropuertos (Bilbao, Madrid, Zaragoza, Barcelona), estaciones (Zaragoza-Delicias, Hendaya) y apoyo al Camino de Santiago. Pago con tarjeta y atención 24/7.",
    keywords: [
      "vtc Logroño",
      "taxi Logroño",
      "traslados Logroño",
      "aeropuerto desde Logroño",
    ],
  },
  {
    slug: "laguardia",
    name: "Laguardia",
    province: "Álava",
    intro: "VTC en Laguardia (Rioja Alavesa): bodegas, enoturismo y aeropuertos.",
    description:
      "Traslados VTC desde y hacia Laguardia, con rutas a bodegas y experiencias de enoturismo. Conexiones con aeropuertos de Bilbao, Vitoria y Zaragoza, además de servicios locales y Camino de Santiago.",
  ...
  },
  {
    ...
    name: "Elciego",
    province: "Álava",
    intro: "VTC en Elciego: hotel Marqués de Riscal, bodegas y traslados a aeropuertos.",
    description:
      "Servicio de VTC en Elciego con traslados a aeropuertos y visitas a bodegas. Recogidas en hoteles y rutas personalizadas por Rioja Alavesa con conductores locales.",
